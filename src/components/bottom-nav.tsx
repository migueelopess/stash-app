  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-border/50 bg-background/70 pt-2.5 pb-[max(0.85rem,env(safe-area-inset-bottom))] backdrop-blur-2xl">
      <div className="relative mx-auto grid max-w-md grid-cols-4">
        ...
        {activeIndex >= 0 && (
          <div
            className="pointer-events-none absolute top-0 left-0 flex h-9 w-1/4 justify-center transition-transform duration-[350ms] ease-[cubic-bezier(0.34,1.3,0.64,1)]"
